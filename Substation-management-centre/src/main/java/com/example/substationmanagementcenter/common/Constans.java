package com.example.substationmanagementcenter.common;
...
public class Constans {
    ...
    public static final String STATUS_MESSAGE="成功";
    ...
    public static final String CODE_MESSAGE="验证码不正确";

    public static final String CODE_OUTTIME_MESSAGE="验证码已过期";
    ...
    public static final String USER_USERNAME_MESSAGE = "用户已存在";
    ...
    public static final String USER_EMAIL_CODE = "50006";
    public static final String USER_EMAIL_MESSAGE = "邮箱已存在";

    public static final String USER_PHONE_CODE = "50007";
    public static final String USER_PHONE_MESSAGE = "手机号码已存在";
